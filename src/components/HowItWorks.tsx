          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
            {items.map((item) => (
              <div key={item.step} className="relative flex justify-center">
                ...
                <div className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-xl mb-4 shadow-lg">
                  {item.step}
                </div>
