        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li>
                <Link href="/resourcing" className="hover:text-blue-400 transition font-medium">
                  Resourcing
                </Link>
              </li>
            </ul>
          ...
          {/* Products */}
          <div>
  <h4 className="font-semibold mb-5 text-sm uppercase tracking-wider text-blue-400">
    OUR PLATFORMS
  </h4>

  <ul className="space-y-4 text-gray-400">
    <li className="flex flex-col">
      <span className="text-sm text-gray-500">Infodra AI</span>
      <a
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="pt-2">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="https://wa.me/919363753540" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-500 transition">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
